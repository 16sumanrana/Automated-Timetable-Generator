...
<html>
<head>
    <title>Subjects | Automated Timetable Generator</title>
    <meta charset="utf-8">
...
<section>
    <div class="container">
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="addsubject" onsubmit="return addsubject(this);">
                        <div class="modal-header">
                            <h5 class="modal-title" id="add-subject-modal-title">Add Subject</h5>
                        ...
                        <div class="modal-body" style="text-align: center;">
                            ...
                            <div class="form-group">
                                <label for="add-subject-subjectname"></label>
                                <input id="add-subject-subjectname" type="text" name="subjectname"
                                       placeholder="e.g. Bengali" class="form-control text-center"
                                       aria-describedby="add-subject-subjectname-HelpInline" required>
                                <small id="add-subject-subjectname-HelpInline" class="text-muted">
        ...
        <div class="modal fade" id="edit-subject-modal" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="edit-subject" onsubmit="return editsubject(this);">
                        <div class="modal-header">
                            <h5 class="modal-title" id="edit-subject-modal-title">Edit Subject</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body" style="text-align: center;">
                            <input type="hidden" name="iseditsubject" value="true">
                            <input type="hidden" name="subjectid" value="" id="edit-subject-subjectid">
                            <div class="form-group">
                                <label for="edit-subject-subjectname"></label>
                                <input id="edit-subject-subjectname" type="text" name="subjectname"
                                       placeholder="e.g. Bengali" class="form-control text-center"
                                       aria-describedby="edit-subject-subjectname-helpline" value="" required>
                                <small id="edit-subject-subjectname-helpline" class="text-muted">
...
<script>
    function loadsubjecttable() {
        $.ajax({
            method: "post",
            url: "<%out.print(Config.BASEURL);%>/SubjectServlet",
            data: {
                isloadsubjecttable: true
            },
            ...
            // console.log(msg);
            if (msg["status"] === true) {
                $("#subjecttable").html(msg["statusText"]);
            } else {
    ...
    function showeditform(form) {
        ...
        $('#edit-subject-subjectid').val(values["subjectid"]);
        $('#edit-subject-subjectname').val(values["subjectname"]);
        $('#edit-subject-modal').modal('toggle');
        return false;
    }

    function editsubject(form) {
